...
def _tier_factories(settings: Settings) -> tuple[object | None, object | None]:
    ...
    if settings.enable_tier3_gliner:
        ...
        tier3 = build_tier3_factory(settings)
...
def create_app(settings: Settings | None = None, *, sink: AuditSink | None = None) -> FastAPI:
    ...
    tier2_factory, tier3_factory = _tier_factories(settings)
